...
public class UpdateUserFaceTask extends BaseAsyncTask {

	public UpdateUserFaceTask(Context ctx, String title, String content) {
	...
	void afterTask(Result result) {
		...
		if(result.getSuccess()!=null && result.getSuccess().toLowerCase().equals("true")){
			if(mContext != null &&
				...
				mPersonInfoActivity.afterFaceTaskDoing();
			}
		}else{
