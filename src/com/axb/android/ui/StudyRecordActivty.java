...
public class StudyRecordActivty extends BaseActivity {
		...
		contentView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				case TIME_INDEX:
					...
					ii.setClass(StudyRecordActivty.this, UndoneTaskActivity.class);
					startActivity(ii);
					break;
				case CASE_INDEX:
					Intent iii = new Intent();
					iii.setClass(StudyRecordActivty.this, CaseStudyActivity.class);
					iii.putExtra("TaskDto", mRecordTaskAdapter.getData().get(arg2));
					startActivity(iii);
					break;
				case ANGUI_INDEX:
					Intent anguiIntent = new Intent();
					anguiIntent.setClass(StudyRecordActivty.this, AnguiStudyActivity.class);
					anguiIntent.putExtra("TaskDto", mRecordTaskAdapter.getData().get(arg2));
					startActivity(anguiIntent);
					break;
				case STUDY_INDEX:			
					Intent i = new Intent();
					i.setClass(StudyRecordActivty.this, FileStudyActivity.class);
